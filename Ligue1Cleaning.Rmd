...
```{r}
ligue1_names17 <- read_csv("16_17_ligue1names.csv")
ligue1_names18 <- read_csv("17_18_ligue1names.csv")
ligue1_names19 <- read_csv("18_19_ligue1names.csv")
standard_ligue1_17 <- read_csv("standardligue1_17.csv")
standard_ligue1_18 <- read_csv("standardligue1_18.csv")
standard_ligue1_19 <- read_csv("standardligue1_19.csv")
ligue1table17 <- read_csv("ligue1table17.csv")
ligue1table18 <- read_csv("ligue1table18.csv")
ligue1table19 <- read_csv("ligue1table19.csv")
ligue1goalkeeper17 <- read_csv("ligue1goalkeeper17.csv")
ligue1goalkeeper18 <- read_csv("ligue1goalkeeper18.csv")
ligue1goalkeeper19 <- read_csv("ligue1goalkeeper19.csv")
```
...
ligue1goalkeeper17 <- ligue1goalkeeper17 %>% 
  ...
  select(-`90s`, -Pos, -Nation, -Squad, -MP, -Starts, -Min, -Age, -Born, -Rk)
```
...
ligue1_fifa18_modeling <- ligue1_fifa18_standard_plus_table %>% 
  ...
  select(-Matches.x, -Matches.y, -Player1, -xG, -npxG, -xA, -npxG_1, -`npxG+xA`, -`npxG+xA_1`, -xG_1, -xA_1, -`xG+xA`, -Starts) %>% 
  mutate(Nation = sub('.* ', '', Nation))
```
