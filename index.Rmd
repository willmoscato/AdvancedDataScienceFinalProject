...
prem_plot_vip <- plot(prem_rf_var_imp)

ggsave('RF_premier_league.PNG', prem_plot_vip)
```

![VIP](RF_premier_league.PNG)
...
```{r}
saveRDS(prem_ranger_test, file = 'somethingdifferent.Rds')
```

```{r}
zzz <- readRDS('somethingdifferent.Rds')
```
...
>>>>>>> 54fd9562119ff2b0a713a0196046ce9da4cce7ab
...
\
Here is our predicted team of the season for Ligue 1 20/21:
\
